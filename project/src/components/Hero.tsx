        ...
        <div className="grid grid-cols-12 gap-8 items-center min-h-[80vh]">
          ...
          <div className="col-span-12 lg:col-span-7 relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-6 animate-slideInUp delay-1000">
              <button className="group bg-gradient-to-r from-[#6e83f7] to-[#A8B5DB] text-white px-10 py-5 rounded-2xl font-bold text-lg hover:shadow-2xl hover:shadow-[#6e83f7]/25 transition-all duration-500 transform hover:-translate-y-2 relative overflow-hidden">
